...
namespace Sitecore.Internals.Services.Serialization.fastJson
{
    #region Formatter
    ...
    public sealed class JSON
    {
                    ...
                    if (v != null)
                    {
                        ...
                        switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.Array:
                                ...
                                // what about 'else'?
                                break;
                            case myPropInfoType.ByteArray: oset = System.Convert.FromBase64String((string)v); break;
#if !SILVERLIGHT
        ...
        private Guid CreateGuid(string s)
        {
            if (s.Length > 30)
                ...
                return new Guid(System.Convert.FromBase64String(s));
        }
            ...
            foreach (List<object> row in rows)
            {
                ...
                foreach (int i in guidcols)
                {
                    ...
                    if (s != null && s.Length < 36)
                        v[i] = new Guid(System.Convert.FromBase64String(s));
                }
    ...
    internal sealed class JSONSerializer
    {
        ...
        {
#if !SILVERLIGHT
            WriteStringFast(System.Convert.ToBase64String(bytes, 0, bytes.Length, Base64FormattingOptions.None));
#else
